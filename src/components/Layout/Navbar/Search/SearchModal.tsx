...
const SearchModal = ({ searchResults, setSearchResults }) => {
  ...
  return (
    <div
      className={`absolute top-[85px] left-[5px] z-[50] 
        bg-white shadow-[0px_8px_24px_rgba(149,157,165,0.2)] 
        flex flex-col p-[15px] border w-[400px] 
        transition-all duration-300 ease-in-out overflow-hidden 
        ${hasResults ? "max-h-[400px]" : "max-h-0 opacity-0"}
      `}
    >
      <div className="w-full h-[50px] flex items-center border-b-[1px] border-[#D0D5DD]">
